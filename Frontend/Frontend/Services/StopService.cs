...
namespace Frontend.Services
{
    ...
    public class StopService
    {
        ...
        public StopService(Stop stopModel, AppShellViewModel appShell,
            MapViewModel mapViewModel, LocationChecker locationChecker, GameService gameService)
        {
            Model = stopModel;
            ViewModel = new StopViewModel(appShell, Model);
        ...
        public void ProcessChange(StopStop stopStop)
        {
